        ...
        try {
            ...
            const response = await fetch(window.WORKER_URL, {
                ...
                headers: { 
                    ...
                    'X-Requested-With': 'EnkaOrderForm' // Защита от ботов
                },
                body: JSON.stringify({
                    event_name: 'Purchase',
                    name: name,
